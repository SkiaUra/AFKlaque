...
Shader "RampShader/Base"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			c.rgb = ( ( _Color * ( staticSwitch173 * ( step( _ShadowStep , ( dotResult125 * step( 0.5 , ase_lightAtten ) ) ) + _ShadowIntensity ) ) * ase_lightColor ) + ( ( 1.0 - saturate( step( _RimOffset , dotResult139 ) ) ) * ( _RimColor * ase_lightColor ) * _RimColor.a ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;2037.988;753.2555;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;135;-2320.644,-97.28511;Inherit;False;1539.971;588.3896;;11;151;159;138;152;148;161;162;155;139;156;150;Rim Light;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldNormalVector;123;-2685.411,-691.6676;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LightAttenuation;136;-2501.948,-343.2308;Inherit;False;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-1983.816,-38.95916;Float;False;Property;_RimOffset;Rim Offset;4;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;124;-2172.865,-641.6358;Inherit;False;Property;_ShadowStep;Shadow Step;1;0;Create;True;0;0;0;False;0;False;0.5;0.72;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;174;-2203.236,-933.55;Inherit;True;Property;_Texture0;Texture 0;6;0;Create;True;0;0;0;False;0;False;None;f30a89f0798e7b44f93be585c36e4c53;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.StepOpNode;127;-1866.694,-625.7728;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;128;-1649.555,-315.695;Inherit;False;Property;_ShadowIntensity;Shadow Intensity;2;0;Create;True;0;0;0;False;0;False;0.5;0.469;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;177;-817.1525,-270.5402;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;170;-619.3308,-517.592;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A931AD651975C330EB0FC9A320E33926DBB14714