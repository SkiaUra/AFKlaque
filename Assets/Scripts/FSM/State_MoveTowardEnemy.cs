...
public class State_MoveTowardEnemy : State_BasicMove {

    private Tween _Tween;

    public override void EnterState(FighterSM FighterSM) { // Do enter shit once
        FighterSM.AnimatorController.SetBool("Walk", true);
        Vector3 pos = _ToolboxMovement.GetPositionTowardEnemy(FighterSM, FighterSM.FighterEntity.ComputedMoveRange);
